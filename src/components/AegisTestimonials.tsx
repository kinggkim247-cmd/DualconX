...
const caseStudies = [
  {
    ...
    quote: "I lost my USDT to a sophisticated drainer. DualconX traced the funds across 4 mixer hops and identified the final exchange endpoint. Most of my capital was returned within 11 days.",
    stars: 5,
    icon: TrendingUp,
    glow: "glow-success",
  },
  {
    ...
    quote: "Locked out of my primary exchange after a SIM-swap. The DualconX team navigated the exchange's legal compliance layer and verified my forensic identity trail to restore access in 72 hours.",
    stars: 5,
    icon: ShieldCheck,
